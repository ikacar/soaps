...
function Products() {
  ...
  return (  
    <section className="products">
          <div className="soap-product" data-aos="slide-right" data-aos-duration="1500">
          ...
          <div className="bath-product"  data-aos="slide-left"  data-aos-duration="2000">
          ...
          <div className="lip-product" data-aos="slide-right" data-aos-duration="2500">
